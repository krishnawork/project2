...
const generatePDF = tickets => {
 ...
 if(localStorage.getItem("type") != "HTP" && localStorage.getItem("type") != "CAT" && localStorage.getItem("type") != "ROR" && localStorage.getItem("type") != "TAT" ){
   ...
   doc.autoTable(tableColumn, tableRows, { startY: 20, columnStyles: {0: {columnWidth: 170}} });
 }else{
   var x=20, y=35;
   ...
   doc.autoTable(tableColumn, tableRows, { startY: 20, columnStyles: {0: {columnWidth: 120}},  margin: { left: 60 },styles: {rowHeight: 15} });
 }
