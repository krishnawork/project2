...
checkoutProgram = (amount,sessions, program_id) => {
    this.props.history.push({
        pathname: '/checkout',
        state: [amount, sessions, program_id, 'program', program_id],
    })
  }
        ...
        return (
            <Fragment>
                ...
                <div className={isMobile?"width-90m":"width-70m"}>
                    <div style={{fontFamily: 'Nunito-Bold', fontSize: '30px'}}>Resolve your family issues</div>
                    <Row style={{marginTop: '20px'}}>
                        <Col md={8}>
                            <img src={family} alt="" style={{width: '100%', height: '350px', objectFit: 'cover'}}/>
                        </Col>
                        <Col md={4}>
                    ...
                    <div className="stepsContainer">
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={family1} alt="" style={{width: '100%'}}/></div>
                            <div>
                        ...
                        <div className="gridProgramP" style={{gridTemplateColumns: '1.3fr 1fr'}}>
                            ...
                            <div><img src={family2} alt="" style={{width: '100%'}}/></div>
                        </div>
                        <div className="curveStyleProgram"><img src={curve2} alt=""/></div>
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={family3} alt="" style={{width: '100%'}}/></div>
                            <div>
