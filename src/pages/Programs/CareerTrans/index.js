...
import transition1 from "../../../assets/images/transition1.png";
import transition2 from "../../../assets/images/transition2.png";
import transition3 from "../../../assets/images/transition3.png";
import transition from "../../../assets/images/career-trans.png";
...
class CareerTrans extends Component {
  constructor(props) {
    super(props);
    this.state = {
      value: 1,
      ...
      <Fragment>
        ...
        <div className={isMobile ? "width-90m" : "width-70m"}>
          ...
          <div className="stepsContainer">
            ...
            >
              <div>
                <img src={transition1} alt="" style={{ width: "100%" }} />
              </div>
              <div>
                <span className="programHeaders">You before this program</span>
                <ul className="listProgram">
                  <li>
                    Don’t have an action plan for a successful career change
                  </li>
                  <li>Have a fear of failure and low self-esteem</li>
                  <li>
                    Find it difficult to say goodbye to your current career
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <ul className="listProgram">
                  <li>Find out what new skills you need to acquire</li>
                  <li>Explore job training programs for a new career</li>
                  <li>Discover how to use your previous experience</li>
                </ul>
              </div>
              <div>
                <img src={transition2} alt="" style={{ width: "100%" }} />
              </div>
            </div>
            <div className="curveStyleProgram">
              <img src={curve2} alt="" />
            ...
            >
              <div>
                <img src={transition3} alt="" style={{ width: "100%" }} />
              </div>
              <div>
                <span className="programHeaders">You after this program</span>
                <ul className="listProgram">
                  <li>Easily set goals and measure your progress</li>
                  <li>Ready to face challenges with confidence</li>
                  <li>Feel satisfied and happy in your life</li>
                </ul>
              </div>
            </div>
          </div>
...
export default withRouter(CareerTrans);
