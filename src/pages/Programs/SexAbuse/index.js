        ...
        return (
            <Fragment>
                ...
                <div className={isMobile?"width-90m":"width-70m"}>
                    <div style={{fontFamily: 'Nunito-Bold', fontSize: '30px'}}>Therapy for Sexual abuse</div>
                    <Row style={{marginTop: '20px'}}>
                        <Col md={8}>
                            <img src={sexAbuse} alt="" style={{width: '100%', height: '350px', objectFit: 'cover'}}/>
                        </Col>
                        <Col md={4}>
                    ...
                    <div className="stepsContainer">
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={sexAbuse1} alt="" style={{width: '100%'}}/></div>
                            <div>
                                ...
                                <ul className="listProgram">
                                    ...
                                    <li>Suffering from anxiety, anger issues, and behavioral disorders</li>
                        ...
                        <div className="gridProgramP" style={{gridTemplateColumns: '1.3fr 1fr'}}>
                            ...
                            <div><img src={sexAbuse2} alt="" style={{width: '100%'}}/></div>
                        </div>
                        <div className="curveStyleProgram"><img src={curve2} alt=""/></div>
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={sexAbuse3} alt="" style={{width: '100%'}}/></div>
                            <div>
                                <span className="programHeaders">You before this program</span>
                                <ul className="listProgram">
