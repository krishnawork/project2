      ...
      <Fragment>
        ...
        <div className={isMobile ? "width-90m" : "width-70m"}>
          <div style={{ fontFamily: "Nunito-Bold", fontSize: "30px" }}>
            Improve your marriage with your partner
          </div>
          ...
          <div className="stepsContainer">
            ...
            >
              <div>
                <img src={marriage1} alt="" style={{ width: "100%" }} />
              </div>
              <div>
            ...
            >
              ...
              <div>
                <img src={marriage2} alt="" style={{ width: "100%" }} />
              </div>
            </div>
            <div className="curveStyleProgram">
              <img src={curve2} alt="" />
            ...
            >
              <div>
                <img src={marriage3} alt="" style={{ width: "100%" }} />
              </div>
              <div>
