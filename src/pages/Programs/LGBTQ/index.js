        ...
        return (
            <Fragment>
                ...
                <div className={isMobile?"width-90m":"width-70m"}>
                    <div style={{fontlgbtq: 'Nunito-Bold', fontSize: '30px'}}>Counselling for LGBTQ individuals</div>
                    <Row style={{marginTop: '20px'}}>
                        <Col md={8}>
                            <img src={lgbtq} alt="" style={{width: '100%', height: '350px', objectFit: 'cover'}}/>
                        </Col>
                        <Col md={4}>
                            <Card className="noBorder shadowCard">
                                <CardBody>
                                    <div style={{fontlgbtq: 'Roboto-SemiBold', fontSize: '16px', textAlign: 'center'}}>Begin your wellness journey now!</div>
                                    <div style={{fontSize: '14px', marginTop :'15px'}}>Program fee<span style={{float: 'right', color: '#DF8F06', fontSize: '20px', fontlgbtq: 'Roboto-Bold'}}>₹4000</span></div>
                    ...
                    <div className="stepsContainer">
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={lgbtq1} alt="" style={{width: '100%'}}/></div>
                            <div>
                                <span className="programHeaders">You before this program</span>
                                <ul className="listProgram">
                                    <li>Find it difficult to cope with discrimination and oppression of society</li>
                                    <li>Have mental health issues</li>
                                    <li>Feel anxious and stressed for coming out as an LGBTQ person</li>
                                </ul>
                            </div>
                        </div>
