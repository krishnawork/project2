        ...
        return (
            <Fragment>
                ...
                <div className={isMobile?"width-90m":"width-70m"}>
                    <div style={{fontsexDis: 'Nunito-Bold', fontSize: '30px'}}>Identify sexual disorders</div>
                    <Row style={{marginTop: '20px'}}>
                        <Col md={8}>
                            <img src={sexDis} alt="" style={{width: '100%', height: '350px', objectFit: 'cover'}}/>
                        </Col>
                        <Col md={4}>
                            <Card className="noBorder shadowCard">
                                <CardBody>
                                    <div style={{fontsexDis: 'Roboto-SemiBold', fontSize: '16px', textAlign: 'center'}}>Begin your wellness journey now!</div>
                                    <div style={{fontSize: '14px', marginTop :'15px'}}>Program fee<span style={{float: 'right', color: '#DF8F06', fontSize: '20px', fontsexDis: 'Roboto-Bold'}}>₹4000</span></div>
                    ...
                    <div className="stepsContainer">
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={sexDis1} alt="" style={{width: '100%'}}/></div>
                            <div>
                                <span className="programHeaders">You before this program</span>
                                <ul className="listProgram">
                                    <li>Facing a problem that prevents you from experiencing sexual satisfaction</li>
                        ...
                        <div className="gridProgramP" style={{gridTemplateColumns: '1.3fr 1fr'}}>
                            <div>
                                <span className="programHeaders">You before this program</span>
                                <ul className="listProgram">
                                    <li>Explore the psychological causes affecting your sex life</li>
                                    <li>Learn to improve the intimacy of your relationship</li>
                                    <li>Address your feeling of anxiety, fear, and poor body image</li>
                                </ul>
                            </div>
                            <div><img src={sexDis2} alt="" style={{width: '100%'}}/></div>
                        </div>
                        <div className="curveStyleProgram"><img src={curve2} alt=""/></div>
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={sexDis3} alt="" style={{width: '100%'}}/></div>
                            <div>
                                <span className="programHeaders">You before this program</span>
                                <ul className="listProgram">
                                    <li>Overcome barriers to a healthy sex life</li>
                                    <li>Take your relationship with your partner to the next level</li>
