      ...
      <Fragment>
        ...
        <div className={isMobile || isTablet ? "width-90m" : "width-70m"}>
            ...
            <Col md={5}>
              <img
                ...
                style={{
                  width: "100%",
                  objectFit: "contain",
                  height: isMobile || isTablet ? "240px" : "350px",
                }}
              />
            </Col>
            <Col md={7}>
              <div
                style={{
                  ...
                  fontSize: "26px",
                  marginBottom: "10px",
                  margin: isMobile || isTablet ? "20px 0px" : "auto",
                }}
              >
              ...
              <div style={{ marginTop: "15px" }}>
                And your employees’ performance depends on their emotional and
              ...
              <div className="divPoint" style={{ marginTop: "20px" }}>
                <div>
                  ...
                  />
                  According to WHO, depression and anxiety disorders cost the
                  global economy US$1 trillion each year.
                </div>
              </div>
            </Col>
          </Row>
          <Row
            ...
            style={{
              boxShadow: "0px 20px 60px #0000001A",
              borderRadius: "30px",
              overflow: "hidden",
              margin: "auto",
            }}
          >
            <Col md={5} style={{ padding: "35px" }}>
              ...
              <div style={{ marginBottom: "10px" }}>
                ...
                />
                To increase productivity and engagement.
              </div>
              <div style={{ marginBottom: "10px" }}>
                <FontAwesomeIcon
                  icon={faCheckSquare}
                ...
                />
                To develop a positive workplace environment.
              </div>
              <div style={{ marginBottom: "10px" }}>
                <FontAwesomeIcon
                  icon={faCheckSquare}
                ...
                />
                To address issues before they become conflicts.
              </div>
              <div style={{ marginBottom: "10px" }}>
                <FontAwesomeIcon
                  icon={faCheckSquare}
                ...
                />
                To reduce the attrition rate in your company.
              </div>
            </Col>
            <Col md={7} style={{ paddingRight: "0px" }}>
              <img
                src={corporate}
                style={{ width: "100%", objectFit: "cover", height: "370px" }}
              />
            </Col>
          </Row>
          <Row
            ...
            <Col md={5}>
              <img
                ...
                style={{
                  width: "100%",
                  objectFit: "contain",
                  height: isMobile || isTablet ? "240px" : "300px",
                }}
              />
            </Col>
            <Col md={7}>
              ...
              >
                Corporate Counselling helps your employees
              </div>
        ...
        >
          <Col md={4}>
            <Card className="shadowBlack noBorder equalHeight">
              ...
              <CardBody>
                <Dotdotdot clamp={1}>
                  <div style={{ fontFamily: "Roboto-Bold", fontSize: "15px" }}>
                ...
                <div
                  style={{ fontFamily: "Roboto-SemiBold", fontSize: "13px" }}
                >
                  Learn More
                </div>
              </CardBody>
        ...
        <div style={{ background: "#F5F5F5", padding: "40px 0px" }}>
          ...
          <Row className="width-70m" style={{ textAlign: "center" }}>
            ...
            <Col
              md={4}
              style={{ marginTop: isMobile || isTablet ? "25px" : "0px" }}
            >
              <Card className="shadowBlack noBorder">
        ...
        <div style={{ padding: "50px 0px", textAlign: "center" }}>
          <div className="width-70m">
            ...
            <div style={{ fontFamily: "Nunito-Bold", fontSize: "44px" }}>
