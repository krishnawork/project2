          ...
          <div style={{ margin: "50px 24px", textAlign: "center" }}>
            <Row style={{ marginBottom: "50px" }}>
              <Col>
                <Card
                  ...
                  onClick={() => this.openCheckout(4200, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
                    >
                      MCMI
                    </div>
                    <div>₹ 4,200</div>
              ...
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(4500, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
            ...
            <Row style={{ marginBottom: "50px" }}>
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(3700, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
              ...
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(4800, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
            ...
            <Row style={{ marginBottom: "50px" }}>
              ...
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(2200, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
            ...
            <Row style={{ marginBottom: "50px" }}>
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(2400, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
            ...
            <Row style={{ marginBottom: "50px" }}>
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(1900, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
                    >
                      Connos Add Checklist
                    </div>
                    <div>₹ 1,900</div>
                    <Button
                      className="buttonSolid"
              ...
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(4600, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
            ...
            <Row style={{ marginBottom: "50px" }}>
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(2300, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
              ...
              <Col>
                <Card
                  className="shadowCard noBorder equalHeight paid"
                  onClick={() => this.openCheckout(4900, 1)}
                >
                  <CardBody>
                    <div
                      style={{ fontSize: "20px", fontFamily: "Nunito-Bold" }}
