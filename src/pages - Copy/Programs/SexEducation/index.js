    ...
    return (
      <Fragment>
        ...
        <div className={isMobile ? "width-90m" : "width-70m"}>
          <div style={{ fontsexEd: "Nunito-Bold", fontSize: "30px" }}>
            Sex Education
          </div>
          ...
          <div className="stepsContainer">
            ...
            >
              <div>
                <img src={sexEd1} alt="" style={{ width: "100%" }} />
              </div>
              <div>
                ...
                <ul className="listProgram">
                  ...
                  <li>
                    Not able to understand the changes happening in your body
                  </li>
            ...
            >
              ...
              <div>
                <img src={sexEd2} alt="" style={{ width: "100%" }} />
              </div>
            </div>
            <div className="curveStyleProgram">
              <img src={curve2} alt="" />
            ...
            >
              <div>
                <img src={sexEd3} alt="" style={{ width: "100%" }} />
              </div>
              <div>
                <span className="programHeaders">You before this program</span>
                <ul className="listProgram">
                  <li>
                    Understand the importance of consent before having sex
                  </li>
