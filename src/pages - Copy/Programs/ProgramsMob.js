      ...
      <Fragment>
        ...
        >
          ...
          <div style={{ fontSize: "10px", width: "85%" }}>
            Duties back crew one on by guest no hides. Then, through delicacy
            all has fifteen her minutes. And to has, she full kind the sisters
            the been to replied if of facilitate invitation and seemed to
            magicians rationalize escape.
          </div>
        </div>
        <div>
          <div>
              ...
              <TabPane tab="All" key="1">
                <div style={{ margin: "50px 24px", textAlign: "center" }}>
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/anger-management/1/anger-management"
                    ...
                    <div className="m-10">
                      <Link
                        to={`/programs/depression/2/Overcome Depression and anxiety`}
                        className="linkStyle blackLink"
                      >
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                don’t let that the insect grow, here’s a chance
                                to kill the bug and be the person you wish to be
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/motivation/3/Self-Motivation"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          <CardImg
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/loneliness/4/Overcome Loneliness"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/procrastination/5/Leave Your Procrastination"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          <CardImg
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                Spontaneity is what we need. Procrastination is
                                as dangerous as a fish out of water
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/self-esteem/6/Develop Self-Esteem and Confidence"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                confidence, you can stand on your feet anywhere
                                and anytime on this planet
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/stress/7/Stress Management"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                It is a practice of calming your nerves so that
                                you don't drown under pressure. Stress
                                management will help you float on water all the
                                time
                              </div>
                            </Dotdotdot>
                            <div
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/family/8/Resolve Your Family Issues"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/relationship/9/Improve Your Relationship With your…"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          <CardImg
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                With two people, come conflicts and love, let's
                                learn to strike a balance and live happier. A
                                little effort is no harm
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/marriage/10/Improve Your Marriage"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                Marriage is not just about love, differences can
                                hamper slowly, lets sort them by bringing a
                                middle way
                              </div>
                            </Dotdotdot>
                            <div
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/marriage-jitters/11/Manage Pre-Wedding Jitters"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          <CardImg
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                Feeling cold feet before marriage is okay, But,
                                to calm those jitters and imagine a happy
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/dream-career/12/Build Your Dream Career"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                Witnessing a dream career turns into reality is
                                the most cherishing moment in life. A career
                                that revolves around you makes YOU!
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/career-transition/13/Easy Career Transition"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/entrepreneurs/14/Counselling for Entrepreneurs"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          <CardImg
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/sexuality/15/Learn to Embrace Your Sexuality"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/sex-education/16/Sex Education"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                and desires. Let’s end the stigma by ending the
                                curiosity and being open about it
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/sexual-disorder/17/Identify Sexual Disorders"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                might affect relationships. Identifying them and
                                opening up plus getting a solution should not be
                                a shy thing
                              </div>
                            </Dotdotdot>
                            <div
                    ...
                    <div className="m-10">
                      <Link
                        to="/programs/sexual-abuse/18/Therapy for Sexual Abuse"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder">
                          ...
                          <CardBody>
                            ...
                            <Dotdotdot clamp={3}>
                              ...
                              >
                                ...
                                all the more difficult to live with it, why not
                                find a way to make peace in our minds
                              </div>
                            </Dotdotdot>
                            <div
                              style={{
                  ...
                  <div className="mobGrid-2" style={{ marginBottom: "30px" }}>
                    <div className="m-10">
                      <Link
                        to="/programs/lgbtq/19/Counselling for LGBTQIA Individual"
                        className="linkStyle blackLink"
                      >
                        <Card className="shadowCard noBorder equalHeight">
