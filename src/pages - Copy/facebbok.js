...
function facebbok() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Mind LYF.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Mind LYF, accessible from{" "}
            <a
              href="https://www.mindlyf.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.mindlyf.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: krushnkantv1@gmail.com</p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>By phone number: 9305819058</p>
        </li>
      </ul>
    </div>
  );
