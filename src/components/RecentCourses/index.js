      ...
      programs: [
        {
          ...
          link: "/programs/anger-management/1/Anger Management",
          desc:
        ...
        },
        {
          ...
          link: "/programs/depression/2/Overcome Depression and anxiety",
          desc:
        ...
        },
        {
          ...
          link: "/programs/motivation/3/Self-Motivation",
          desc:
        ...
        },
        {
          ...
          link: "/programs/loneliness/4/Overcome Loneliness",
          desc:
        ...
        },
        {
          ...
          link: "/programs/procrastination/5/Leave Your Procrastination",
          desc:
        ...
        },
        {
          ...
          link: "/programs/self-esteem/6/Develop Self-Esteem and Confidence",
          desc:
        ...
        },
        {
          ...
          link: "/programs/stress/7/Stress Management",
          desc:
            "It is a practice of calming your nerves so that you do not drown under pressure. Stress management will help you float on water all the time",
        },
        {
          img: family,
          name: "Resolve Your Family Issues",
          link: "/programs/family/8/Resolve Your Family Issues",
          desc:
            "Together we stand, divided we fall. Resolving family issues should always be a priority",
        },
        {
          img: relationship,
          name: "Improve Your Relationship With your…",
          link: "/programs/relationship/9/Improve Your Relationship With your…",
          desc:
            "With two people, come conflicts and love, let us learn to strike a balance and live happier. A little effort is no harm",
        },
        {
          img: marriage,
          name: "Improve Your Marriage",
          link: "/programs/marriage/10/Improve Your Marriage",
          desc:
            "Marriage is not just about love, differences can hamper slowly, lets sort them by bringing a middle way",
        },
        {
          img: marriageJitter,
          name: "Manage Pre-Wedding Jitters",
          link: "/programs/marriage-jitters/11/Manage Pre-Wedding Jitters",
          desc:
            "Feeling cold feet before marriage is okay, But, to calm those jitters and imagine a happy married life is priceless",
        },
        {
          img: dreamCareer,
          name: "Build Your Dream Career",
          link: "/programs/dream-career/12/Build Your Dream Career",
          desc:
            "Witnessing a dream career turns into reality is the most cherishing moment in life.  A career that revolves around you makes YOU!",
        },
        {
          img: careerTrans,
          name: "Easy Career Transition",
          link: "/programs/career-transition/13/Easy Career Transition",
          desc:
            "Changing jobs can be difficult at times. No transition is ever easy. But having a mentor would make it like having a walk in a park",
        },
        {
          img: entrepreneur,
          name: "Counselling for Entrepreneurs",
          link: "/programs/entrepreneurs/14/Counselling for Entrepreneurs",
          desc:
            "Entrepreneurship is like making a new dish but not knowing whether people will like it or no. This phase of entrepreneurs is the most sensitive one which needs counselling",
        },
        {
          img: sexuality,
          name: "Learn to Embrace Your Sexuality",
          link: "/programs/sexuality/15/Learn to Embrace Your Sexuality",
          desc:
            "Knowing yourself is not wrong! A hidden sexuality is a sign of reluctancy. A sign that you don’t like yourself which results in unhappiness and enraged mood swings",
        },
      ],
    };
  }
  render() {
    return (
      <Fragment>
        <div
          className="width-70"
          style={{ textAlign: "center", margin: "30px auto 30px auto" }}
        >
          <div
            style={{
              ...
              <Slider style={{ height: "450px" }}>
                {this.state.programs.map((org, index) => (
                  <Slide
                    key={index}
                    index={index}
                    style={{ paddingBottom: "0%", marginTop: "7px" }}
                  >
                    <Link to={org.link} className="linkStyle blackLink">
                      <Card
                        className="shadowCard noBorder equalHeight"
                        style={{ margin: "20px" }}
                      >
